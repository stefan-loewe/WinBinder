...
if(!defined("ID_LEVEL")) define("ID_LEVEL", 2120);
if(!defined("IDC_STATIC2119")) define("IDC_STATIC2119", 2119);
if(!defined("ID_SPINNER")) define("ID_SPINNER", 2121);
if(!defined("ID_TREE")) define("ID_TREE", 2112);

// Create window

$dlg = wb_create_window($parent, 2, "Edit Categories", WBC_CENTER, WBC_CENTER, 337, 295, 0, 0);
